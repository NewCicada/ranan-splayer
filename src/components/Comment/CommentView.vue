<template>
  <n-card class="comment" hoverable>
    <div class="user">
      <div class="avatar">
        <img class="avatarImg" :src="commentData.user.avatarUrl.replace(/^http:/, 'https:') + '?param=50y50'"
          alt="avatar" />
        <img class="musicPackage" v-if="commentData.user.vipRights &&
          commentData.user.vipRights.musicPackage
          " :src="commentData.user.vipRights.musicPackage.iconUrl" alt="vip" />
      </div>
      <div class="associator" v-if="commentData.user.vipRights && commentData.user.vipRights.redVipLevel
        ">
        <img v-if="commentData.user.vipRights.associator" :src="commentData.user.vipRights.associator.iconUrl"
          alt="associator" />
      </div>
    </div>
    <div class="review">
