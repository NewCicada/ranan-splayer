  ...
  <div class="cover">
    ...
    <div class="control">
      <div class="data">
        ...
        <n-icon class="like" size="20" :component="music.getSongIsLike(music.getPlaySongData.id)
            ? FavoriteRound
            : FavoriteBorderRound
          " @click.stop="
    ...
    " />
      ...
      <div class="time">
        ...
        <n-slider v-model:value="songTimeVal" class="progress" :step="0.01" @update:value="songTimeSliderUpdate" />
