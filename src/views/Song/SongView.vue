      ...
      <div class="right">
        <div class="intr">
          ...
          <div class="album">
            ...
            <n-text class="text" v-html="musicDetail.al.name" @click="router.push(`/album?id=${musicDetail.al.id}`)" />
          </div>
        ...
        <div class="button">
          ...
          <n-button strong secondary @click="router.push(`/comment?id=${musicDetail.id}`)">
            <template #icon>
              <n-icon :component="MessageFilled" />
            </template>
            评论
          </n-button>
          <n-button strong secondary v-if="musicDetail.mv" @click="router.push(`/video?id=${musicDetail.mv}`)">
            <template #icon>
