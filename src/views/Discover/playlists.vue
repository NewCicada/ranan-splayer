<template>
  <div class="playlists">
    <div class="menu">
      <!-- 分类选择 -->
      <n-button class="cat" icon-placement="right" round @click="catModelShow = true">
        <template #icon>
    ...
    <Pagination v-if="playlistsData[0]" :totalCount="totalCount" @pageSizeChange="pageSizeChange"
