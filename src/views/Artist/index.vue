<template>
  <div class="artist">
    <div class="artistData" v-if="artistData">
      <div class="cover">
        <n-avatar round class="coverImg" :src="artistData.cover.replace(/^http:/, 'https:') + '?param=300y300'"
      ...
      <div class="data">
        ...
        <n-modal v-model:show="artistDescShow" preset="card" style="width: 60vw" title="歌手介绍" :bordered="false">
    ...
    <n-tabs class="main-tab" type="segment" @update:value="tabChange" v-model:value="tabValue" v-if="artistId">
